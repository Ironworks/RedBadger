...
class FileReaderTests: XCTestCase {
    ...
    func testFileNotFound() {
        sut = FileReader(fileName: "unknown", type: "txt")
        do {
            _ = try sut.readFile()
            
        } catch FileReaderErrors.fileNotFound {
            XCTAssertTrue(true, "Should throw file not found error")
        } catch {
            XCTFail()
        }
    }
    ...
    func testEmptyFile () {
        ...
        do {
            _ = try sut.readFile()
        } catch FileReaderErrors.emptyFile {
            XCTAssertTrue(true, "Should throw empty file error")
        } catch {
            XCTFail()
        }
    }
